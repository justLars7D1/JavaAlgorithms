...
public class LeastSquares {
    ...
    public double[] computeCoefficients(Basis basis, Function weight, double[] xs, double[] ys) {
    ...
    private double[][] generateBasisMatrix(Basis basis, Function weight, double[] xs) {
    ...
    private double[] generateResultVector(Basis basis, Function weight, double[] xs, double[] ys) {
        assert xs.length == ys.length;
